try {
    ...
    const scratchCardCover = document.querySelector('.lib-scratch-card-cover');
    const scratchCardCanvasRender = document.querySelector('.lib-scratch-card-canvas-render');
    const scratchCardCoverContainer = document.querySelector('.lib-scratch-card-cover-container');
    const scratchCardText = document.querySelector('.lib-scratch-card-text');
    const scratchCardImage = document.querySelector('.lib-scratch-card-image');
